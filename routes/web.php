...
Route::get('/registerpage', 'PagesController@registerpage');
Route::get('/foodDisplay', 'PagesController@fDisplay')->name('home.show');
Route::get('/postUpdateDisplay', 'PagesController@postUpdateDisplay')->name('home.show');

Route::get('/getimage','PagesController@pdisplay');
Route::post('registerUpdate', 'company@companyUpdate')->name('company.store');
Route::post('postUpdate', 'PagesController@postUpdate')->name('post.store');
Route::post('comlogin', 'company@comlogin');
